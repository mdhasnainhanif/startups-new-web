...
import { StoryTestimonialData } from "../../data/contentWriting";

interface CWStoryTestimonialProps {
  data: StoryTestimonialData;
}

export function CWStoryTestimonial({ data }: CWStoryTestimonialProps) {
  return (
    <Section variant="dark" id="case-studies" className="sectionPadding border-y border-[#2f2a63]/50">
      <Container maxWidth="xl">
        <div className="text-center mb-12 py-16">
          <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-primary/10 border border-primary/30 mb-6 mx-auto">
            <span className="text-sm text-primary">Client Success Story</span>
          </div>
          <div className="sectionHeading">
            <h2>
              From <span className="text-white/60">{data.heading.text}</span> to{" "}
