  ...
  tabs: [
    {
      ...
      image: '/assets/images/designer-page/branding-identity-design.webp',
      deliverables: [
        ...
        { id: '9', label: 'Website UI/UX Design', image: '/assets/images/designer-page/website-uiux-design.webp' },
        ...
        { id: '12', label: 'Social Media Advertising Creatives', image: '/assets/images/designer-page/social-media-advertising-creatives.webp' },
        { id: '13', label: 'Digital Marketing Assets', image: '/assets/images/designer-page/digital-marketing-assets.webp' },
        ...
        { id: '17', label: 'Motion Graphics Design', image: '/assets/images/designer-page/motion-graphics-design.webp' },
        { id: '18', label: 'Video Editing & Graphic Overlays', image: '/assets/images/designer-page/video-editing-graphic-overlays.webp' },
        { id: '19', label: '3D Modeling & Product Rendering', image: '/assets/images/designer-page/3d-modeling-product-rendering.webp' },
        { id: '20', label: 'Advertising & Campaign Design', image: '/assets/images/designer-page/advertising-campaign-design.webp' },
        { id: '21', label: 'Brochure, Flyer & Catalog Design', image: '/assets/images/designer-page/brochure-flyer-catalo-design.webp' },
        { id: '22', label: 'Ebook & Publication Layout Design', image: '/assets/images/designer-page/ebook-publication-layout-design.webp' },
        { id: '23', label: 'Email Newsletter & HTML Template Design', image: '/assets/images/designer-page/email-newsletter-html-template-design.webp' },
        { id: '24', label: 'Environmental & Signage Design', image: '/assets/images/designer-page/environmental-signage-design.webp' },
      ],
      gridItems: 24,
    },
    {
