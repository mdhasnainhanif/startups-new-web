...
export default function ContactPage() {
  ...
  return (
    ...
    <Container maxWidth="2xl">
      <div className="max-w-4xl mx-auto mb-8 sm:mb-12 lg:mb-16 text-center contactMain sectionHeading heroBannerPaddingTop contactSectionHero">
        <h1 className="mb-2 max-w-4xl mx-auto md:pt-60">
