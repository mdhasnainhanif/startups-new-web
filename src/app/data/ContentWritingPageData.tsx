...
export const contentWritingCompleteSetupData: CompleteBusinessSetupData = {
  ...
  brandingKits: {
    items: [
      ...
      { id: "4", number: "04", label: "Search-Optimized Formatting" },
      { id: "5", number: "05", label: "Featured Snippet Targeting" },
      ...
      { id: "65", number: "65", label: "Engagement-Focused Writing" },
      ...
      { id: "83", number: "83", label: "Long-Form to Micro-Content" },
      ...
      { id: "100", number: "100", label: "Email + Landing Page Alignment" },
      ...
      { id: "119", number: "119", label: "Influencer Content Mapping" },
