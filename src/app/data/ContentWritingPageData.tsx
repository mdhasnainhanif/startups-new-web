  ...
  tabs: [
    {
      ...
      deliverables: [
        ...
        { id: '13', label: 'B2C Content Writing', image: '/assets/images/aipower1.webp' },
        { id: '14', label: 'Website Content Writing', image: '/assets/images/aipower1.webp' },
        { id: '15', label: 'Thought Leadership Writing', image: '/assets/images/aipower1.webp' },
        { id: '16', label: 'Content Editing & Proofreading', image: '/assets/images/aipower1.webp' },
        { id: '17', label: 'Content Repurposing', image: '/assets/images/aipower1.webp' },
        { id: '18', label: 'Press Releases & PR Writing', image: '/assets/images/aipower1.webp' },
        { id: '19', label: 'Lead Magnet Content', image: '/assets/images/aipower1.webp' },
        { id: '20', label: 'Content for Funnels', image: '/assets/images/aipower1.webp' },
        { id: '21', label: 'SMS & Micro-Copywriting', image: '/assets/images/aipower.webp' },
        { id: '22', label: 'Marketing Collateral Writing', image: '/assets/images/aipower1.webp' },
        { id: '23', label: 'Community & Engagement Writing', image: '/assets/images/aipower1.webp' },
        { id: '24', label: 'Content Distribution & Marketing', image: '/assets/images/aipower1.webp' },
      ],
      gridItems: 24,
    },
    {
      ...
      deliverables: [
        { id: '1', label: 'Sales page copy', image: '/assets/images/aipower1.webp' },
        { id: '2', label: 'Landing page messaging', image: '/assets/images/aipower2.webp' },
        { id: '3', label: 'Call-to-action sets', image: '/assets/images/aipower3.webp' },
        { id: '4', label: 'Offer explanation lines', image: '/assets/images/aipower4.webp' },
        { id: '5', label: 'Short-form conversion copy', image: '/assets/images/aipower5.webp' },
        { id: '6', label: 'Lead-focused content', image: '/assets/images/aipower1.webp' },
        { id: '7', label: 'Value-driven messaging', image: '/assets/images/aipower2.webp' },
        { id: '8', label: 'Script lines', image: '/assets/images/aipower3.webp' },
        { id: '9', label: 'Segment-specific variations', image: '/assets/images/aipower4.webp' },
        { id: '10', label: 'Commercial writing essentials', image: '/assets/images/aipower5.webp' },
      ],
      gridItems: 10,
    },
    {
      ...
      image: '/assets/images/aipower1.webp',
      deliverables: [
        { id: '1', label: 'Button labels', image: '/assets/images/aipower1.webp' },
        { id: '2', label: 'Form microcopy', image: '/assets/images/aipower2.webp' },
        { id: '3', label: 'Navigation text', image: '/assets/images/aipower3.webp' },
        { id: '4', label: 'Onboarding lines', image: '/assets/images/aipower4.webp' },
        { id: '5', label: 'Instructional messaging', image: '/assets/images/aipower5.webp' },
        { id: '6', label: 'State messages', image: '/assets/images/aipower1.webp' },
        { id: '7', label: 'Section titles', image: '/assets/images/aipower2.webp' },
        { id: '8', label: 'Feature descriptions', image: '/assets/images/aipower3.webp' },
        { id: '9', label: 'User guidance wording', image: '/assets/images/aipower4.webp' },
        { id: '10', label: 'Complete UX content refinement', image: '/assets/images/aipower5.webp' },
      ],
      gridItems: 10,
    },
    {
      ...
      image: '/assets/images/aipower1.webp',
      deliverables: [
        { id: '1', label: 'Ad headlines', image: '/assets/images/aipower1.webp' },
        { id: '2', label: 'Primary message sets', image: '/assets/images/aipower2.webp' },
        { id: '3', label: 'Short-form hooks', image: '/assets/images/aipower3.webp' },
        { id: '4', label: 'Audience-focused variations', image: '/assets/images/aipower4.webp' },
        { id: '5', label: 'Offer highlights', image: '/assets/images/aipower5.webp' },
        { id: '6', label: 'Retargeting lines', image: '/assets/images/aipower1.webp' },
        { id: '7', label: 'Caption-based ads', image: '/assets/images/aipower2.webp' },
        { id: '8', label: 'Video copy prompts', image: '/assets/images/aipower3.webp' },
        { id: '9', label: 'Angle testing ideas', image: '/assets/images/aipower4.webp' },
        { id: '10', label: 'Performance-aligned ad content', image: '/assets/images/aipower5.webp' },
      ],
      gridItems: 10,
    },
  ],
