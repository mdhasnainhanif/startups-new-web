  ...
  tabs: [
    {
      ...
      deliverables: [
        { id: '1', label: 'Frontend Development', image: '/assets/images/web-development/day-web-package/frontend-development.jpg' },
        { id: '2', label: 'Backend Development', image: '/assets/images/web-development/day-web-package/backend-development.jpg' },
        { id: '3', label: 'Full-Stack Development', image: '/assets/images/web-development/day-web-package/full-stack-development.jpg' },
        ...
        { id: '7', label: 'API Development & Integration', image: '/assets/images/web-development/day-web-package/api-development-integration.jpg' },
