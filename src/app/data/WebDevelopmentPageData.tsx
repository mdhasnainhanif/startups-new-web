    ...
    tabs: [
      {
        ...
        deliverables: [
          ...
          { id: '7', label: 'API Development & Integration', image: '/assets/images/web-development/api-development-integration.webp' },
          { id: '8', label: 'Database Development', image: '/assets/images/web-development/database-development.webp' },
          { id: '9', label: 'UI/UX Web Design', image: '/assets/images/web-development/ui-ux-webdesign.webp' },
          { id: '10', label: 'Mobile First Web Development', image: '/assets/images/web-development/mobile-first-web-development.webp' },
          { id: '11', label: 'Website Redesign & Optimization', image: '/assets/images/web-development/website-redesign-optimization.webp' },
          { id: '12', label: 'SEO Web Development', image: '/assets/images/web-development/seo-web-development.webp' },
          { id: '13', label: 'Landing Page Development', image: '/assets/images/web-development/landingpage-development.webp' },
          { id: '14', label: 'Web Hosting & Deployment', image: '/assets/images/web-development/web-hosting-deployment.webp' },
          { id: '15', label: 'Performance Optimization', image: '/assets/images/web-development/performance-optimization.webp' },
          { id: '16', label: 'Security & Compliance', image: '/assets/images/web-development/security-compliance.webp' },
          { id: '17', label: 'Custom Plugin & Module Development', image: '/assets/images/web-development/custom-plugin-module-development.webp' },
          { id: '18', label: 'Automation & Scripting', image: '/assets/images/web-development/automation-scripting.webp' },
          { id: '19', label: 'DevOps for Web Projects', image: '/assets/images/web-development/devops-for-web-projects.webp' },
          { id: '20', label: 'Cloud Web Development', image: '/assets/images/web-development/cloudweb-development.webp' },
          { id: '21', label: 'Enterprise Web Development', image: '/assets/images/web-development/enterprise-web-development.webp' },
          { id: '22', label: 'Maintenance & Support', image: '/assets/images/web-development/maintenance-support.webp' },
          { id: '23', label: 'QA & Testing', image: '/assets/images/web-development/qa-testing.webp' },
          { id: '24', label: 'API Driven Headless Development', image: '/assets/images/web-development/api-driven-headless-development.webp' },
        ],
        gridItems: 24,
      },
    ],
