...
export const webDevelopmentCompleteSetupData: CompleteBusinessSetupData = {
  ...
  brandingKits: {
    items: [
      ...
      { id: "3", number: "03", label: "Responsive UI Development" },
      ...
      { id: "25", number: "25", label: "Payment Gateway Integration" },
      ...
      { id: "53", number: "53", label: "Loading Speed Optimization" },
      ...
      { id: "60", number: "60", label: "Crawl & Index Optimization" },
      { id: "61", number: "61", label: "Conversion-Optimized Pages" },
      ...
      { id: "80", number: "80", label: "Compliance Implementation" },
      ...
      { id: "120", number: "120", label: "Frontend Framework Integration" },
    ],
  },
  benefits: {
