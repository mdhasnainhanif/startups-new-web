...
export const socialMediaMarketingCompleteSetupData: CompleteBusinessSetupData = {
  ...
  brandingKits: {
    items: [
      ...
      { id: "11", number: "11", label: "Monthly Content Calendars" },
      { id: "12", number: "12", label: "Campaign Scheduling" },
      { id: "13", number: "13", label: "Posting Frequency Planning" },
      ...
      { id: "20", number: "20", label: "Brand Guideline Alignment" },
      ...
      { id: "28", number: "28", label: "Competitor Movement Tracking" },
      ...
      { id: "54", number: "54", label: "Content Performance Reviews" },
      { id: "55", number: "55", label: "Recommendations for Improvement" },
      ...
      { id: "72", number: "72", label: "Negative Comment Strategy" },
      { id: "73", number: "73", label: "Public Response Drafting" },
      { id: "74", number: "74", label: "Reputation Recovery" },
      { id: "75", number: "75", label: "Emergency Content Planning" },
      ...
      { id: "80", number: "80", label: "Customer Satisfaction Tracking" },
      ...
      { id: "108", number: "108", label: "Content Approval Workflows" },
      { id: "109", number: "109", label: "Influencer-UGC Mix Strategy" },
      { id: "110", number: "110", label: "Rights & Usage Management" },
      { id: "111", number: "111", label: "Awareness → Interest → Conversion Flows" },
      { id: "112", number: "112", label: "Content Layered Funnels" },
      { id: "113", number: "113", label: "Retargeting Sequences" },
      { id: "114", number: "114", label: "Multi-Touch Funnel Mapping" },
      ...
      { id: "119", number: "119", label: "Opportunity Gap Identification" },
